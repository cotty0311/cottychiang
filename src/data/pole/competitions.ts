...
export const competitions = [
	{
		...
		expenses: [
			{ category: '私人課', amount: 11200, color: '#ff719b' },
			{ category: '治裝費', amount: 5124, color: '#63e6ff' },
			{ category: '娛樂費', amount: 320, color: '#ffd36a' },
			{ category: '租管', amount: 6740, color: '#9b87ff' },
			{ category: '報名費', amount: 7666, color: '#ff9cdb' },
			{ category: '維修費', amount: 5300, color: '#6fffb0' },
		],
	},
	{
		id: 'pso2026',
		...
		expenses: [
			{ category: '私人課', amount: 16000, color: '#ff719b' },
			{ category: '租管', amount: 11675, color: '#63e6ff' },
			{ category: '報名費', amount: 8840, color: '#9b87ff' },
			{ category: '治裝費', amount: 3450, color: '#ff9cdb' },
			{ category: '道具費', amount: 1525, color: '#ffd36a' },
			{ category: '鋼管週邊', amount: 453, color: '#6fffb0' },
			{ category: '交通費', amount: 230, color: '#8ca5ff' },
		],
	},
].map((competition) => ({
	...competition,
